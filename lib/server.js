...
function attachStatic(inst) {
    ...
    inst.app.get('/brackets',function(req,res,next) {
    ...
    inst.app.get('/support/extensions/*',function(req,res,next) {
            try {
...
function Server(app,srv, opts) {
    if (!(this instanceof Server)) {
        return new Server(app,srv, opts);
    }
    ...
    this.supportDir = removeTrailingSlash(opts.supportDir || path.resolve("./support"));
